    ...
    <div className="min-h-screen flex justify-center items-center bg-cover bg-center" style={{ backgroundImage: "url('/images/backgroundregistervisitor.png')", backgroundSize: '100%' }}>
      <div className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg relative">
        <div className="flex justify-between items-center mb-4">
          ...
          >
            <span className="inline-flex items-center">
              ...
              <Link to="../Login">Log in as Vendor / Log in Sebagai Vendor </Link>
            </span>
          </button>
        </div>
        <h1 className="text-2xl mb-4"><b>Visitor Dashboard</b></h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className={`w-full py-2 bg-red-600 text-white rounded hover:bg-red-700 ${styles['submit-button']}`} type="submit">Masuk / Log in</button>
        </form>
